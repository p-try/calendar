...
<div class="togglebuttons">
	...
	<button class="button middle" ng-value="month" ng-model="selectedView" uib-btn-radio="'month'"><?php p($l->t('Month')); ?></button>
	<button class="button last" ng-value="year" ng-model="selectedView" uib-btn-radio="'year'"><?php p($l->t('Year')); ?></button>
</div>
<div class="togglebuttons">
